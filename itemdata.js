...
var items = [
  ...
  {name: "default:beef_cooked", displayName: "Steak", placeable: false, icon: "textures/items/beef_cooked.png"},
  ...
  {name: "default:diamond_hoe", displayName: "Diamond Hoe", onPlace: function(pos) {if("farmingTill" in mods) {var ret=mods.farmingTill(pos);if(ret) {useHUDActiveItem();}} return false;}, icon: "textures/items/diamond_hoe.png", stackable: false, maxStack: 1, isConsumable: false, isTool: true, toolLife: 1562, toolGroups: [], toolSpeedMul: 8, toolLevel: TOOL_LEVEL_DIAMOND},
  ...
  {name: "default:gold_hoe", displayName: "Gold Hoe", onPlace: function(pos) {if("farmingTill" in mods) {var ret=mods.farmingTill(pos);if(ret) {useHUDActiveItem();}} return false;}, icon: "textures/items/gold_hoe.png", stackable: false, maxStack: 1, isConsumable: false, isTool: true, toolLife: 33, toolGroups: [], toolSpeedMul: 12, toolLevel: TOOL_LEVEL_GOLD},
  ...
  {name: "default:iron_hoe", displayName: "Iron Hoe", onPlace: function(pos) {if("farmingTill" in mods) {var ret=mods.farmingTill(pos);if(ret) {useHUDActiveItem();}} return false;}, icon: "textures/items/iron_hoe.png", stackable: false, maxStack: 1, isConsumable: false, isTool: true, toolLife: 251, toolGroups: [], toolSpeedMul: 6, toolLevel: TOOL_LEVEL_IRON},
  ...
  {name: "default:stone_hoe", displayName: "Stone Hoe", onPlace: function(pos) {if("farmingTill" in mods) {var ret=mods.farmingTill(pos);if(ret) {useHUDActiveItem();}} return false;}, icon: "textures/items/stone_hoe.png", stackable: false, maxStack: 1, isConsumable: false, isTool: true, toolLife: 132, toolGroups: [], toolSpeedMul: 4, toolLevel: TOOL_LEVEL_STONE},
  ...
  {name: "default:wood_hoe", displayName: "Wood Hoe", onPlace: function(pos) {if("farmingTill" in mods) {var ret=mods.farmingTill(pos);if(ret) {useHUDActiveItem();}} return false;}, icon: "textures/items/wood_hoe.png", stackable: false, maxStack: 1, isConsumable: false, isTool: true, toolLife: 60, toolGroups: [], toolSpeedMul: 2, toolLevel: TOOL_LEVEL_WOOD, furnaceFuel: 10},
